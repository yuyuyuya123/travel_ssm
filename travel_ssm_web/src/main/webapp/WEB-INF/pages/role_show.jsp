            ...
            <div class="container-fluid">
                ...
                <div class="card card-info">
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                        <tr colspan="2" data-toggle="collapse" data-target="#permission">
                            <td>${role.roleName}</td>
                        </tr>
                        <c:forEach items="${role.permissions}" var="permission">
                            <tr class="collapse" id="permission" data-toggle="collapse" data-target="#permission" style="text-indent: 20px;">
