    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="card card-info">
                ...
                <!-- form -->
                <form role="form" action="${pageContext.request.contextPath}/role/insertOneRole.do">
                    <!-- card-body -->
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>角色名</label>
                                    <input type="text" class="form-control" placeholder="Enter ..." name="roleName" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>描述</label>
                                    <input type="text" class="form-control" placeholder="Enter ..." name="roleDesc">
                                </div>
                            </div>
                        </div>
                      </div>
