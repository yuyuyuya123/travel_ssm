    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/permission/findAll.do">权限管理</a></li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            <div class="card card-info">
                ...
                <!-- form -->
                <form role="form" action="${pageContext.request.contextPath}/permission/insertOnePermission.do">
                    <!-- card-body -->
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>权限名</label>
                                    <input type="text" class="form-control" placeholder="Enter ..." name="permissionName" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>描述</label>
                                    <input type="text" class="form-control" placeholder="Enter ..." name="url">
                                </div>
                            </div>
                        </div>
                    </div>
